...
To populate our internal database of medical documents, Pubmed and Springer were decided as the top two sources due to their quality, scope, and size. Furthermore, Pubmed's API enables easy data ingestion. In Springer's case, Beautiful Soup was used to scrape the articles.
